...
class FinContractRepositoryInMemory implements FinContractRepository
{
    ...
    public function __construct()
    {
        $this->finContracts = [
            ...
            "wETH_axlUSDC"      =>  ["contract" => "kujira1suhgf5svhu4usrurvxzlgn54ksxmn8gljarjtxqnapv8kjnp4nrsqq4jjh", "decimals" => 12],
            "axlUSDT_axlUSDC"   =>  ["contract" => "kujira1xut80d09q0tgtch8p0z4k5f88d3uvt8cvtzm5h3tu3tsy4jk9xlscem692"],
            "xAVAX_axlUSDC"     =>  ["contract" => "kujira1qjxu65ucccpg8c5kac8ng6yxfqq85fluwd0p9nt74g2304qw8eyq930y7w", "decimals" => 12],
            ...
            "wBNB_axlUSDC"      =>  ["contract" => "kujira1apkgj87fgfsq84swvkyfaemrq7t4deuh60887lek0hkgdjh5fj0qaz7fhx", "decimals" => 12],
            "DOT_axlUSDC"       =>  ["contract" => "kujira1w4t2qpwvhyhz0g2mwgqjzgsw63dcy5hkfch0tgr8xj9qjcsauq8q5x0zxz", "decimals" => 4],
            "gPAxG_axlUSDC"     =>  ["contract" => "kujira12p30cr4gstmp2yucwxtaq92turrzsxxar8upz3rhmfjxh6gdgk4s5vsyse", "decimals" => 12],
            "MARS_axlUSDC"      =>  ["contract" => "kujira149m52kn7nvsg5nftvv4fh85scsavpdfxp5nr7zasz97dum89dp5qevttd9"],
            "wTAO_axlUSDC"      =>  ["contract" => "kujira17qp8g5n5wwelrsnfdakrv0p550nzg72agpcz5t0ea6thlqd300hquxljcc", "decimals" => 12],
            ...
            "wBNB_USK"      =>  ["contract" => "kujira1a0fyanyqm496fpgneqawhlsug6uqfvqg2epnw39q0jdenw3zs8zqsjhdr0", "decimals" => 12],
            ...
            "wMATIC_USK"    =>  ["contract" => "kujira1rrnacml8zeqq3ve2t98r5x88t4uahahdk66y9qpcrjp9qxhnuvysv59zx8", "decimals" => 12],
            ...
            "wETH_USK"      =>  ["contract" => "kujira17w9r23r8v8r7z5lphwj99296fhlye9ej5nq3hlqw554u63m88avspdl9tc", "decimals" => 12],
            ...
            "DOT_USK"       =>  ["contract" => "kujira1jlzw6xal0n2c580g3wxs09tjhlzdht9y8dgszq3tupf8fhl7xjus7ep7ap", "decimals" => 4],
            "CMDX_USK"      =>  ["contract" => "kujira1h7eenquygffwsmc8csrlx88zcddwx0aqspq3x2dsl20lwk4r9n2q9t86ht"],
            "wAVAX_USK"     =>  ["contract" => "kujira1fphguznhazgqdlr9mpfh6nmn3vjjr73ksz3ukznv6q7s9ndfq2cs8vhapj", "decimals" => 12],
            ...
            "gPAxG_USK"     =>  ["contract" => "kujira1rtpn4nxkx7u5y4uf5lp4ywrhmnms07p8p8wc3pmw53hfv0lhyxdqlfhgrt", "decimals" => 12],
            "DAI_USK"       =>  ["contract" => "kujira18lm235jzuh4t7hh5z8lqyz08dmz67magj8z0fc4a0vn6c0hzk0es3r4glx", "decimals" => 12],
            "wTAO_USK"      =>  ["contract" => "kujira1538ukswznmuek3hfv7mcxem9hjqz8sa4ypl2ul0zncu3tdgfvwmq8pxkwp", "decimals" => 12],
            ...
            "LINK_USK"      =>  ["contract" => "kujira12zjpumtfh88k6s2s8k4wks37ezr2c3zeha5xx6qpd65e5ehz50nq0afvrv", "decimals" => 12],
            ...
            // *** ATOM PAIRS
            "KUJI_ATOM"             => ["contract" => "kujira18v47nqmhvejx3vc498pantg8vr435xa0rt6x0m6kzhp6yuqmcp8s4x8j2c", "nominative" => "ATOM_axlUSDC"],
            "stATOM_ATOM"           => ["contract" => "kujira158zzjcvkz7r3j5hueurcw22qrjerqw4dtrzlalztr7whjykjwvrsrahdnq", "nominative" => "ATOM_axlUSDC"],
            "LP KUJI_ATOM (ATOM)"   => ["contract" => "kujira1gl8js9zn7h9u2h37fx7qg8xy65jrk9t4zpa6s7j5hdlanud2uwxshqq67m", "nominative" => "ATOM_axlUSDC"],
            "LP KUJI_ATOM (KUJI)"   => ["contract" => "kujira1hs95lgvuy0p6jn4v7js5x8plfdqw867lsuh5xv6d2ua20jprkgesw2pujt", "nominative" => "KUJI_axlUSDC"],

            // *** LUNA PAIRS
            "KUJI_LUNA" => ["contract" => "kujira1xqhakgvn3jeqfade0z4aufer9xylx7ft45fgyhg6z75mauhkjwks9cucyq", "nominative" => "LUNA_axlUSDC"],
            "ampLUNA_LUNA" => ["contract" => "kujira172qjrk8g9l86w0shz4cc3e6rt5h9janaen4j4u6ze7xkjvjnaqfskwyyqm", "nominative" => "LUNA_axlUSDC"],

            // *** OSMO PAIRS
            "ATOM_OSMO" => ["contract" => "kujira1hulx7cgvpfcvg83wk5h96sedqgn72n026w6nl47uht554xhvj9nsra5j5u", "nominative" => "OSMO_axlUSDC"],

            // *** WETH PAIRS
            "wstETH_wETH" => ["contract" => "kujira1ehwsdvgs3chpxuexktymjmmjj68m3h4q67p9vjj9rrgjqycc3gtsfzej24", "nominative" => "wETH_axlUSDC", "decimals" => 18]
        ];
    }
