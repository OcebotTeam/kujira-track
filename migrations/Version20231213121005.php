 ...
 */
final class Version20231213121005 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bow_tvl (id INT AUTO_INCREMENT NOT NULL, pair VARCHAR(255) NOT NULL, token VARCHAR(255) NOT NULL, balance VARCHAR(255) NOT NULL, tracked DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE total_value_locked (id INT AUTO_INCREMENT NOT NULL, pair VARCHAR(255) NOT NULL, denom VARCHAR(255) NOT NULL, amount DOUBLE PRECISION NOT NULL, tracked DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE total_value_locked');
